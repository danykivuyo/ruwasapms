...
class DistrictsTableSeeder extends Seeder
{
	...
	{
		//
		$regions = json_decode($this->jsonString, true);

		// Loop through each region and its districts
		foreach ($regions as $regionData) {
			$region = Region::firstOrCreate(['name' => $regionData['name']]);

			foreach ($regionData['districts'] as $districtData) {
				$region->districts()->create(['name' => $districtData['name']]);
			}
		}
	}
}
